        ...
        switch (whichStage) {
            case 1: 
                ...
                if (soldier.getSoldierXCoordinate() >= 995 && 
                    ...
                    Greenfoot.setWorld(new StageFour(50, 350, 0));
                    whichStage = 4;
                ...
                if (soldier.getSoldierXCoordinate() <= 5 && 
                    soldier.getSoldierYCoordinate() > 220 && 
                    soldier.getSoldierYCoordinate() < 480) {
                    Greenfoot.setWorld(new StageSix(950, soldier.getY(), 180));
                    whichStage = 6;
            ...
            case 2: 
                ...
                if (soldier.getSoldierYCoordinate() >= 695 && 
                    soldier.getSoldierXCoordinate() > 400 && 
                    soldier.getSoldierXCoordinate() < 600) {
                    Greenfoot.setWorld(new StageOne(500, 50, 90));
                    whichStage = 1;
                    //soldier.setLocation(500, 50);
                }
                break;
            case 3: 
                ...
                if (soldier.getSoldierYCoordinate() >= 695 && 
                    soldier.getSoldierXCoordinate() > 400 && 
                    soldier.getSoldierXCoordinate() < 600) {
                    Greenfoot.setWorld(new StageTwo(500, 50, 90));
                    whichStage = 2;
                    //soldier.setLocation(500, 50);
                }
                break;
            case 4:
                ...
                if (soldier.getSoldierXCoordinate() <= 5 && 
                    soldier.getSoldierYCoordinate() > 220 && 
                    soldier.getSoldierYCoordinate() < 480) {
                    Greenfoot.setWorld(new StageOne(950, 350, 180));
                    whichStage = 1;
            ...
            case 5:
                ...
                if (soldier.getSoldierXCoordinate() <= 5 && 
                    soldier.getSoldierYCoordinate() > 220 && 
                    soldier.getSoldierYCoordinate() < 480) {
                    Greenfoot.setWorld(new StageFour(950, 350, 180));
                    whichStage = 4;
                    //soldier.setLocation(950, 350);
                }
                break;
            case 6:
                ...
                if (soldier.getSoldierXCoordinate() >= 995 && 
                    soldier.getSoldierYCoordinate() > 220 && 
                    soldier.getSoldierYCoordinate() < 480) {
                    Greenfoot.setWorld(new StageOne(50, 350, 0));
                    whichStage = 1;
                    //soldier.setLocation(50, 350);
                }
                break;
            case 7: 
                ...
                if (soldier.getSoldierXCoordinate() >= 995 && 
                    soldier.getSoldierYCoordinate() > 220 && 
                    soldier.getSoldierYCoordinate() < 480) {
                    Greenfoot.setWorld(new StageSix(50, 350, 0));
                    whichStage = 6;
                    //soldier.setLocation(50, 350);
                }
                break;
            case 8: 
                ...
                if (soldier.getSoldierYCoordinate() <= 5 && 
                    soldier.getSoldierXCoordinate() > 400 && 
                    soldier.getSoldierXCoordinate() < 600) {
                    Greenfoot.setWorld(new StageOne(500, 650, 270));
                    whichStage = 1;
                    //soldier.setLocation(500, 650);
                }
                break;
